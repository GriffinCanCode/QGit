...
from qgits.qgit_gui import (
    run_gui,
    show_help,
)
from qgits.qgit_logger import logger
from qgits.qgit_snapshot import (
    cleanup_snapshots,
    create_snapshot,
    list_snapshots,
)
...
def setup_environment():
    ...
    try:
        ...
        print(f"Error setting up QGit environment: {e!s}")
        return False
...
def main() -> Optional[int]:
    ...
    try:
        ...
        parser = argparse.ArgumentParser(
            description="QGit - A Git operations automation tool"
        )
        ...
        commands = {
            ...
            "stats": (
                ...
                "Generate repository statistics",
                {
                    ...
                    "--leaderboard": (
                        "store_true",
                        "Show interactive leaderboard of contributors",
                    ),
                },
            ),
            "doctor": (
                ...
                "Check repository health",
                {
                    ...
                    "--check-lfs": (
                        "store_true",
                        "Include Git LFS configuration checks",
                    ),
            ...
            "last": (
                ...
                "Show last commit details",
                {
                    ...
                    "--safespace": (
                        "store_true",
                        "Create safespace for current changes",
                    ),
                },
            ),
            "shove": (
            ...
            "undo": (
                ...
                "Safely undo recent operations",
                {
                    ...
                    "--remote-safe": (
                        "store_true",
                        "Prevent affecting remote branches",
                    ),
                },
            ),
            "ancestry": (
                None,
                "Show 3D repository visualization",
                {
            ...
            for arg_name, arg_spec in cmd_args.items():
                if len(arg_spec) == 2:  # Simple argument
                    ...
                    if arg_type == "store_true":
                        ...
                        cmd_parser.add_argument(
                            f"--{arg_name.lstrip('-')}", type=arg_type, help=arg_help
                        )
